...
#    Updated: 2017/12/29 20:44:03 by nerahmou    ###    #+. /#+    ###.fr      #
#                                                                              #
# **************************************************************************** #
...
ft_isascii.c ft_putchar.c ft_strcpy.c ft_strncmp.c ft_trimsplit.c ft_isdigit.c ft_putchar_fd.c ft_strdel.c ft_strncpy.c\
ft_isprint.c ft_putendl.c ft_strdup.c ft_strnequ.c ft_itoa.c ft_putendl_fd.c ft_strequ.c ft_strnew.c ft_memalloc.c ft_putnbr.c ft_putnbrendl.c\
...
ft_lstmap.c ft_lstnew.c ft_swap.c ft_list_size.c ft_trimsplit.c ft_foreach.c ft_sqrt.c ft_lstdisplay_str.c ft_lstpushback_str.c \
